...
class Router
{
    ...
    protected function setAdminRoutes()
    {
        ...
        $attributes['namespace'] = 'App\Admin\Controllers';

        $this->router->group($attributes, function ($router) {
            $router->resources([
                'auth/supervisor'  => 'SupervisorController',
            ...
            $router->post('auth/changePassword', 'AuthController@postChangePassword');
        });
    }
