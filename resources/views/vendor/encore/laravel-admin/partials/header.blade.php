...
<header class="main-header">
    ...
    <a href="/admin" class="logo">
        ...
        <span class="logo-mini"><b>{{config('admin.logo-mini')}}</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>{{config('admin.logo-lg')}}</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <button class="btn btn-default btn-flat" data-toggle="modal" data-target="#change-password" class="bootstrap-modal-form-open">{{ Lang::get('admin::lang.change_password') }}</button>
                            </div>
