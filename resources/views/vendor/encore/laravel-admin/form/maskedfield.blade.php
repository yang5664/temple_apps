<div class="form-group {!! !$errors->has($label) ?: 'has-error' !!}">
    ...
    <div class="col-sm-8">
        ...
        <div class="input-group">
            ...
            @if(isset($index))
                <input type="text" id="{{$relation}}_{{$index}}_{{$id}}" name="{{$relation."[$index][$name]"}}" value="{{ old($column, $value) }}" class="form-control"  placeholder="{{ Lang::get('admin::lang.input') }} {{$label}}">
            @else
