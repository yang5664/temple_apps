...
@else
<script src="{{ asset ("https://maps.googleapis.com/maps/api/js?key=").config('admin.google_map_key')}}&libraries=places"></script>
@endif

{{-- plugin --}}
<script src="{{ asset ("/js/slimscroll/jquery.slimscroll.min.js") }}"></script>
<script src="{{ asset ("/js/bsModalForm/src/laravel-bootstrap-modal-form.js")}}" ></script>
